...
from notifier.client import JsonResponseType, Auth
...
def test_fetch_weather_returns_correct_conditions(weather_data: dict, subscription: Subscription):
    client = StubApiClient(data=weather_data)

    conditions = services.fetch_weather(client, subscription)
